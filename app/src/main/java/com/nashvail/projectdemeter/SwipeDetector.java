...
* Class : SwipeDetector
* ---------------------------------------------------------
* Detects right to left , or left to swipes on views
* Credit : taken from an answer on StackOverflow by user Gal Rom
* Link : http://stackoverflow.com/questions/6645537/how-to-detect-the-swipe-left-or-right-in-android
 */
